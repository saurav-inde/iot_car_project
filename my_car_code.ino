...
SoftwareSerial BT_Serial(2, 3); // bluetooth Hc05 trans receiver pin
...
#define enA 10 //ena l298 12v pin no
#define in1 9 //Motor1  L298 Pin in1 pin out 1
#define in2 8 //Motor1  L298 Pin in1 pin out 2
#define in3 7 //Motor2  L298 Pin in1 pin out 3
#define in4 6 //Motor2  L298 Pin in1 pin out 4
#define enB 5 //Enable2 L298 Pin enB 5v pin no

#define servo A4

#define R_S A0 //ir sensor Right pin
#define L_S A1 //ir sensor Left pin

#define echo A2    //Echo pin ultasonic
...
int bt_ir_data; //ir reciever data receiver 
int Speed = 130;  
int mode=0;
int IR_data;
